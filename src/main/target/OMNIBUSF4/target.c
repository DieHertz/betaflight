...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    DEF_TIM(TIM10, CH1, PB8,  TIM_USE_PWM | TIM_USE_PPM,   0, 0), // S1_IN, PPM
    ...
    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_MOTOR,               0, 0), // S4_OUT
    ...
    DEF_TIM(TIM8,  CH1, PC6,  TIM_USE_PWM,                 0, 0), // UART6_TX
    DEF_TIM(TIM8,  CH2, PC7,  TIM_USE_PWM,                 0, 0), // UART6_RX
};
